...
directory = 'bloomz'  # Change this to your target directory
...
<head>
    ...
    <title>Bloomz-SubSet-Finetune</title>
    <style>
        .image-grid {
            display: flex;
            flex-wrap: wrap;
...
<body>
    <h1>Bloomz Detector trained on ChatGPT generations</h1>
...
output_file = os.path.join(directory, "Bloomz.html")
