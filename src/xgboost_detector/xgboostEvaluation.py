...
class EvaluationXGBoost:
    ...
    def performance_test(self, X_test_list, y_test_list, dstype):
        ...
        precisionscore = precision_score(y_test_list, y_pred, average='micro', zero_division=1.0)
        recallscore = recall_score(y_test_list, y_pred, average='micro', zero_division=1.0)
